...
%>
			...
			<div class="buy-list mb-3">
				<p>주문/배송 현황 조회</p>
<%
	List<Order> orders = orderDetailDto.selectAllOrdersByMemberNo(memberNo);
	if (orders.isEmpty()) {
%>
				...
				<div class="order-list-box">
					<div class="row">
						<div class="col-2 mt-2">
							...
							<a href="claim-order-detail.jsp" style="color:black;"><span><%=order.getNo() %></span></a>
						</div>
					...
					<div class="row mt-3 mb-3">
						...
						<div class="col mt-4 text-end">
							<span style="color:red; font-weight: bold;"><%=order.getTotalPrice() %></span>
							<span>원</span>
						</div>
